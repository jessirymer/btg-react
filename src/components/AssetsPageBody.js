...
// <div className="modal fade" id="asset_variations" tabindex="-1" role="dialog" aria-labelledby="asset_variations" aria-hidden="true">
...
//                             </button>
//                             <h2>Go Daddy For Good (4548)</h2>
//                             <h4>Company Logo</h4>
//                             <div className="asset-list">
//                                 <div className="row border-bottom">
//                                     <div className="col align-self-center">
//                                     <img className="img-fluid" src="https://soflo.ecompanystore.com/Api/Attachment/Thumbnail/83151" alt="" />
//                                 </div>
//                                 <div className="col">
//                                     <h4>Asset Id: 4548</h4>
...
//                             <button className="btn btn-lg">Add Variation</button>
//                         </div>
//                     </div>
//                 </div>
//             </div>
