...
const AssetItem = ({key, name, client, store, type, imgsrc, versions}) => {
    return (
        <div className="col-sm-6 col-md-4 col-lg-3 asset-spacing">
                ...
                <div className="front">
                    ...
                    <div className="asset-title ng-binding">
                        ...
                        <h4 className="text-center">
                            <strong><a href="/#" data-toggle="modal" data-target="#asset_variations" title="View the versions of this asset.">{versions.length} Versions</a> | <a href="/#" title="Add an additional versi`on to this asset.">Add</a></strong>
                        </h4>
                    </div>
                </div>
            </div>
